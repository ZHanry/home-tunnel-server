...
> `v3.2.0` 由 `v3.2.0-rc.2` 的同一提交和同一套不可变资产提升。服务端 Linux `amd64`/`arm64` 与 Linux 客户端为 Stable；macOS headless 为 Beta；Windows x64 EXE 与 Android 8.0+ `arm64-v8a` 客户端为 Experimental。
