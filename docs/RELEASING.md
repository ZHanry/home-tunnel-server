...
> **v5.0 rule:** build `v5.0.0-rc.N` first. The stable `v5.0.0` tag must reuse its exact commit, image digests, and complete asset set.
...
uses `versionName=5.0.0` and `versionCode=5000000`, calculated as
