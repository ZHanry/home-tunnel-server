...
The restricted Agent is independently versioned `4.0.0`. Its source build is
...
| Restricted Agent API adaptation | Pass | Agent 4.0.0 uses the 0.70.1 configuration-source, aggregation, validation and unsafe-feature policy APIs. |
