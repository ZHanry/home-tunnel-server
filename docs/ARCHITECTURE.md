...
Home Tunnel separates control traffic from proxied application traffic. Caddy is the only public HTTP/TLS entry point; FRPS exposes a separate TCP listener for managed Windows and Linux Agents.
