import { api, refreshSession } from "./modules/api.js?v=2.5.0-modules1";
import {
  componentLabel,
  configState,
  escapeHtml,
  ...
  formatDate,
  statusBadge,
} from "./modules/format.js?v=2.5.0-modules1";
import { localeTag, updateDocumentMetadata } from "./modules/locale.js?v=2.5.0-modules1";
import { connectRealtime, disconnectRealtime } from "./modules/realtime.js?v=2.5.0-modules1";
import { state } from "./modules/state.js?v=2.5.0-modules1";
