...
const devices = [
  { id: ids.device, user_id: ids.user, username: "lin", name: "书房主机", status: "active", online: true, client_version: "2.2.4", applied_config_version: 12, config_version: 12, last_seen_at: new Date(now - 12_000).toISOString(), lease_expires_at: new Date(now + 21_600_000).toISOString() },
  { id: ids.deviceTwo, user_id: ids.userTwo, username: "ops.demo", name: "家庭服务器", status: "active", online: false, client_version: "2.2.4", applied_config_version: 4, config_version: 5, last_seen_at: new Date(now - 3_600_000).toISOString(), lease_expires_at: null },
];
const connections = [
...
app.get("/api/v1/public/releases/latest", (_request, response) => response.json({
  version: "2.2.4",
  architecture: "x64",
  file_name: "HomeTunnel-Setup-2.2.4-x64.exe",
  ...
  download_url: "https://github.com/ZHanry/home-tunnel/releases/download/v2.2.4/HomeTunnel-Setup-2.2.4-x64.exe",
}));
